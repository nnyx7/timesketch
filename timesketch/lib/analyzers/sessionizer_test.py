...
from timesketch.lib.analyzers.base_sessionizer_test import _set_database
...
class TestSessionizerPlugin(BaseTest, BaseSessionizerTest):
    ...
    def test_multiple_sessions(self):
        ...
        _set_database(ds, 0, 3, time_diffs=[3000, 400000000])
    ...
    def test_zero_time_diff(self):
        ...
        _set_database(ds, 0, 2, time_diffs=[0])
